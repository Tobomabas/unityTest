...
// --- Camera work -----------------------------------------------------------------------------------------------------------------------------------
		...
		{
			shakeIntensity = shakeStartDuration = shakeRemainingDuration = 0;
			lastShake = playerMovement = cameraMovement = movement = movementCurrentVector = lockOnMovement = lockOnCurrentVector = cursorFollowMovement = cursorFollowCurrentVector = Vector3.zero;
