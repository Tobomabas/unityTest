...
namespace FlexibleCamera
{
	public class FlexCamRestrictor : MonoBehaviour
	{
		...
		[Header ("General")]
		[Tooltip ("Enables of disables the entire restrictor. Be reminded that the FlexCam.cs script also has an option to enable it and that both have to be enabled.")] public bool Active = true;
...
// --- Internal Basics -------------------------------------------------------------------------------------------------------------------------------
		...
		/// <summary> Applies the restrictions to the given vector. </summary>
