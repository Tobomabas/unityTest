...
New (1.1): Now has 3 modes:
Keeping the vertical constant is the standard Unity behavior, causing this script to do nothing.
Keeping the horizontal constant is the behavior described above.
Keeping the shortest constant should be best if you want to build your game on both PC and mobile, but also if
you want to be able to rotate the screen on your mobile device. This is set to the new standard behavior.
